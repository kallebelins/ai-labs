# Lab 52: 52 Extracao Dados Pdf

## Problema a ser resolvido

Extrair e estruturar dados de PDFs variados (notas fiscais, contratos, artigos).

## Métricas de teste detalhadas

### Métricas principais
- **Taxa de extração correta, cobertura de campos.**: Métrica específica do laboratório
...
### pdfplumber
- **O que resolve**: Extração de dados de PDFs
...
### Dados limpos em JSON a partir de PDFs reais.
