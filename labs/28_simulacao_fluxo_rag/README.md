# Lab 28: 28 Simulacao Fluxo Rag

## Problema a ser resolvido

Simular fluxo de consulta RAG ponta a ponta.

## Métricas de teste detalhadas

### Métricas principais
- **Precisão final, rastreabilidade do fluxo.**: Métrica específica do laboratório
...
### Simulação didática para onboarding de novos devs.
