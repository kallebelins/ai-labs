# Lab 51: 51 Classificacao Emails Spam

## Problema a ser resolvido

Classificar e-mails como spam ou não usando IA.

## Métricas de teste detalhadas

### Métricas principais
- **Precision, recall, F1-score em conjunto de e-mails rotulados.**: Métrica específica do laboratório
...
### API de classificação de e-mails com relatório de métricas.
