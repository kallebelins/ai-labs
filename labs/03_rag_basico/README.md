...
Implementar um pipeline RAG básico.

## Métricas de teste detalhadas

### Métricas principais
- **Recall de contexto, precisão de respostas contextualizadas.**: Métrica específica do laboratório
...
### Sistema que utiliza RAG para enriquecer respostas.
