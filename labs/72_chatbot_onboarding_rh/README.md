# Lab 72: 72 Chatbot Onboarding Rh

## Problema a ser resolvido

Automatizar o onboarding de novos funcionários via chatbot.

## Métricas de teste detalhadas

### Métricas principais
- **Tempo médio de onboarding, satisfação, cobertura de informações.**: Métrica específica do laboratório
...
### Processo de integração 100% digital e interativo.
