# Lab 23: 23 Summarization Rag

## Problema a ser resolvido

Experimentar sumarização assistida via RAG.

## Métricas de teste detalhadas

### Métricas principais
- **Qualidade de resumo, fidelidade ao texto original.**: Métrica específica do laboratório
...
### Resumos automáticos via consulta a bases.
