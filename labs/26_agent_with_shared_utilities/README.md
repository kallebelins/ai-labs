# Lab 26: 26 Agent With Shared Utilities

## Problema a ser resolvido

Garantir reutilização de código entre agentes via shared_utilities.

## Métricas de teste detalhadas

### Métricas principais
- **Redução de duplicidade, cobertura de testes.**: Métrica específica do laboratório
...
### Modularidade máxima nos agentes.
