# Lab 7: 07 Roteirizacao Docker

## Problema a ser resolvido

Automatizar a orquestração de labs com Docker Compose.

## Métricas de teste detalhadas

### Métricas principais
- **Facilidade de setup, tempo de deploy.**: Métrica específica do laboratório
...
### Ambientes prontos e replicáveis para experimentos.
