# Lab 98: 98 Lab Roteirizacao Turismo

## Problema a ser resolvido

Criar roteiros turísticos personalizados com IA.

## Métricas de teste detalhadas

### Métricas principais
- **Satisfação do usuário, adequação das sugestões.**: Métrica específica do laboratório
...
### integrações APIs turismo
- **O que resolve**: Solução específica do laboratório
- **Implementação**: Integração com o pipeline principal

## Resultado esperado

### Roteiro automático e personalizado para cada viajante.
