# Lab 21: 21 Tool Plugins Openai

## Problema a ser resolvido

Criar, registrar e testar ferramentas plugáveis no OpenAI Functions.

## Métricas de teste detalhadas

### Métricas principais
- **Facilidade de extensão, cobertura de funcionalidades.**: Métrica específica do laboratório
...
### FastAPI
- **O que resolve**: Framework web para APIs REST
- **Implementação**: Integração com o pipeline principal

## Resultado esperado

### Catálogo de plugins de ferramentas.
