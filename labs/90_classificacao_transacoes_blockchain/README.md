# Lab 90: 90 Classificacao Transacoes Blockchain

## Problema a ser resolvido

Classificar transações blockchain como suspeitas ou normais.

## Métricas de teste detalhadas

### Métricas principais
- **Acurácia, recall, taxa de detecção de fraude.**: Métrica específica do laboratório
...
### Alerta para transações atípicas em tempo real.
