# Lab 54: 54 Detecta Fraudes Transacoes

## Problema a ser resolvido

Detectar transações financeiras fraudulentas usando machine learning.

## Métricas de teste detalhadas

### Métricas principais
- **ROC AUC, precision, recall, taxa de falsos positivos.**: Métrica específica do laboratório
...
### Modelo de detecção de fraudes com painel de análise.
