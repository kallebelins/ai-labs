# Lab 87: 87 Avaliacao Projetos Engenharia

## Problema a ser resolvido

Avaliar automaticamente projetos de engenharia (plantas, diagramas, orçamentos).

## Métricas de teste detalhadas

### Métricas principais
- **Taxa de detecção de inconsistências, satisfação dos engenheiros.**: Métrica específica do laboratório
...
### Feedback automático em projetos.
