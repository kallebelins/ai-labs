# Lab 8: 08 Integra N8N Llm

## Problema a ser resolvido

Orquestrar fluxos de automação com n8n integrando LLMs.

## Métricas de teste detalhadas

### Métricas principais
- **Automação de tarefas, tempo de processamento.**: Métrica específica do laboratório
...
### Workflows de IA totalmente automatizados.
