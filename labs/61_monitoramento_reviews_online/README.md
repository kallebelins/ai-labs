# Lab 61: 61 Monitoramento Reviews Online

## Problema a ser resolvido

Monitorar menções/reviews de marcas em tempo real nas redes sociais.

## Métricas de teste detalhadas

### Métricas principais
- **Cobertura, tempo de detecção, análise de sentimento.**: Métrica específica do laboratório
...
### Twitter API
- **O que resolve**: API para acesso a dados do Twitter
...
### Painel de menções e sentimentos de marca.
